...
typedef NS_ENUM(NSUInteger, FishPagerControllerDirection) {
    FishPagerControllerLeft,
    FishPagerControllerRight,
    FishPagerControllerNone,
};

@interface FishPagerController ()<UIScrollViewDelegate> {
...
@implementation FishPagerController
...
- (void)setDelegate:(id<FishPagerControllerDelegate>)delegate
{
    _delegate = delegate;
...
- (void)configurePagerIndex
{
    ...
    // scroll direction
    FishPagerControllerDirection direction = offsetX >= _preOffsetX ? FishPagerControllerLeft : FishPagerControllerRight;
    ...
    // caculate cur index
    if (direction == FishPagerControllerLeft) {
